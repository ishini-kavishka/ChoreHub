...
export default function SplashScreen() { useEffect(() => { ExpoSplashScreen.hideAsync(); const timer = setTimeout(() => router.replace('/auth/welcome'), 1100); return () => clearTimeout(timer); }, []); return <View style={styles.screen}><View style={styles.mark}><Text style={styles.markText}>C</Text></View><Text style={styles.name}>ChoreHub</Text><Text style={styles.tagline}>A calmer way to share the load.</Text></View>; }
